      ...
      promptContent = [
        {
          ...
          Example format (do not copy the content, only mimic the style):
          Design an opulent and fully furnished living room within a space framed by deep charcoal gray walls, a light oak wood floor, a recessed ceiling with sharp dark gray molding, and large, multi-pane windows dressed with nearly invisible sheer curtains, revealing a panoramic city view; in the center of the room, place a large, plush camel-colored leather L-shaped sectional sofa, facing the windows, adorned with luxurious velvet throw pillows in emerald green, sapphire blue, and muted gold, anchored by a massive rectangular dark walnut coffee table topped with a stack of oversized art books, a crystal vase filled with creamy white peonies, a golden candleholder set, and a brass sculpture centerpiece; to the right of the sectional, position a sleek black metal side table holding an ivory ceramic table lamp and an antique brass clock, while two deep green velvet armchairs with black metal frames sit in front of the windows, separated by a small round marble-top accent table displaying a crystal decanter set with glasses; behind the armchairs, install a tall, dark wood open shelving unit filled with curated books, glass ornaments, small abstract sculptures, and a few trailing plants cascading over the shelves; against the right wall, build a custom dark walnut console with a polished marble top, supporting two modern table lamps with geometric shades, a gold-framed abstract painting hanging above, and a collection of designer vases and decor pieces spread stylishly across the surface; immediately to the side, add a large potted fiddle-leaf fig tree in a matte charcoal ceramic planter to bring an organic touch and vibrant contrast to the muted palette; on the opposite wall, incorporate a built-in bar cabinet finished in deep wood tones, its open shelves lit with soft strip LED lighting showcasing crystal glassware, artisan liquor bottles, and a golden ice bucket; above the seating area, suspend a grand, modern chandelier in brushed gold, radiating a soft ambient glow throughout the room; additional black metal and dark wood nesting tables scattered near the sectional hold magazines, artisanal coasters, and minimalist sculptures; the light oak floors shine subtly under the layered lighting, continuing seamlessly toward the back of the room where linear recessed lights are embedded along the ceiling edges, casting an elegant wash across the charcoal gray walls, further adorned with an arrangement of large-format black-and-white photographic prints in slim gold frames, adding depth and character; complete the luxurious atmosphere with a variety of textured elements like the soft richness of velvets, the cool smoothness of marble, the warm gleam of metals, and the natural grain of dark woods, creating a harmonious blend of modern opulence, timeless sophistication, and serene spaciousness where every corner is filled yet balanced, masterpiece, best quality, highres, lora:more_details:0.5 lora:SDXLrender_v2.0:1. Only produce the generated prompt text, without any additional commentary or explanations.`,
        },
      ];
    }
